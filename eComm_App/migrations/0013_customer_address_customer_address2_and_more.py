...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('eComm_App', '0012_order_payment_razorpay_id_order_transaction_id_and_more'),
    ]
